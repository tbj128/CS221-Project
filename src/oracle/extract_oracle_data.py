"""
This file extracts the number of days number of days that a prescription was prescribed for for each patient
as well as some basic information on a patient's status and age.
