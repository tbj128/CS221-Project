"""
Extracts all data from the eICU dataset regarding a particular patient-stay.

For example, given a patient ID, we will grep for all journal lines with that ID in all relevant patient files.
"""
